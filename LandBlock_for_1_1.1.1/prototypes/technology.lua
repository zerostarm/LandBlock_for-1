...
},
{
  type = "technology",
  name = "sb-startup1",
  icon = "__LandBlock_for_1__/graphics/technology/ore.png",
  icon_size = 128,
  effects = {
...
},
{
  type = "technology",
  name = "sb-startup2",
  icon = "__LandBlock_for_1__/graphics/technology/basic-circuit-board.png",
  icon_size = 128,
  effects = {
...
--[[
{
  type = "technology",
  name = "sb-startup3",
  icon = "__LandBlock_for_1__/graphics/technology/coal.png",
  icon_size = 128,
  effects = {
...
]]--
{
  type = "technology",
  name = "sb-startup4",
  icon = "__LandBlock_for_1__/graphics/technology/lab.png",
  icon_size = 128,
  effects = {
